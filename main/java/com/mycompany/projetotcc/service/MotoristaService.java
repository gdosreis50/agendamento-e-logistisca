package com.mycompany.projetotcc.service;
...
public class MotoristaService {
    ...
    public static boolean atualizaMotorista(String nome, String cpf, String cnh, Date dataVenc, String catCnh, String telefone, int idFunc) throws Exception{
